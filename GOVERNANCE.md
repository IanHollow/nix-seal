...
`main` should require signed-off commits, review, passing required checks, and no
force pushes. Releases follow SemVer. CLI, plan, artifact, plugin protocol, and
module compatibility are versioned independently where necessary. Deprecations
remain for at least one minor release.
