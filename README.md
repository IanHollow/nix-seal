...
`activation.v2`, and template-parser boundaries. It deserializes untrusted
bytes, validates successful documents, checks their public JSON serialization
round trips, and renders accepted templates through a bounded writer; the plan
